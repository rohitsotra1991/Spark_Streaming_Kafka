...
def main():
    ...
    pwords = spark.sparkContext.textFile("F:\Python\PySpark\Data\Twitter_Sentiment_Analysis_Using_Spark_Kafka\positive.txt")
    nwords = spark.sparkContext.textFile("F:\Python\PySpark\Data\Twitter_Sentiment_Analysis_Using_Spark_Kafka\negative.txt")
